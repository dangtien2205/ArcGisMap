...
public class MapFragment extends Fragment implements BasemapsDialogFragment.BasemapsDialogListener,
    ...
    private com.example.tienbi.arcgismap.mode.Location lo;

    public static MapFragment newInstance(String portalItemId,
                                          String basemapPortalItemId, com.example.tienbi.arcgismap.mode.Location loc) {
        MapFragment mapFragment = new MapFragment(loc);
    ...
    public static MapFragment newInstance1(String portalItemId,
    ...
    public MapFragment(com.example.tienbi.arcgismap.mode.Location loc) {
        this.lo = loc;
    }
...
//    }
    ...
    private void setMapView(final MapView mapView) {
        ...
        final MapViewHelper mvHelper = new MapViewHelper(mMapView);
        ...
        mMapView.setOnStatusChangedListener(new OnStatusChangedListener() {
            ...
            public void onStatusChanged(Object source, STATUS status) {
                ...
                Drawable mIcon = null;
                if (lo != null) {
                    switch (lo.getId_type()){
                        case 1:
                            mIcon = getResources().getDrawable(R.drawable.gas_marker_48px);
                            break;
                        case 2:
                            mIcon = getResources().getDrawable(R.drawable.atm_marker_48px);
                            break;
                        case 3:
                            mIcon = getResources().getDrawable(R.drawable.mart);
                            break;
                        case 4:
                            mIcon = getResources().getDrawable(R.drawable.restaurent);
                            break;
                        case 5:
                            mIcon = getResources().getDrawable(R.drawable.hospital_marker_48px);
                            break;
                        default:
                            break;
                    }
                    mvHelper.addMarkerGraphic(lo.getLatitude(), lo.getLongtitude(), lo.getName_point(), "Gas", android.R.drawable.ic_menu_myplaces, mIcon, false, 1);
                    mMapView.centerAndZoom(lo.getLatitude(), lo.getLongtitude(), 16);
                } else {
                    ArrayList<com.example.tienbi.arcgismap.mode.Location> listLoc = DatabaseManager.getInstance().getLocation();
